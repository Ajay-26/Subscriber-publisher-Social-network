...
public class AVLTree{
	...
	public AVLTreeNode findTreeWithTime(int t){
		if(this.root == null){
			return null;
		}else{
			if(this.root.data.time == t){
				return this.root;
			}else if(this.root.data.time > t){
				return this.leftSubTree().findTreeWithTime(t);
			}else{
				return this.rightSubTree().findTreeWithTime(t);
			}
		}
	}
